    ...
    addEventLayout: [
      {
        title: "Name",
        numColls: 1,
        colls: [[TicketEvent.eventFields.name]]
      },
      {
        title: "Numbers",
        numColls: 2,
        colls: [
          ...
          [
            TicketEvent.eventFields.ticketCost,
            TicketEvent.eventFields.eventCost
          ]
        ]
      },
      {
      ...
      },
      {
        title: "Venue",
        numColls: 1,
        colls: [[TicketEvent.eventFields.venueId]]
      },
      {
        title: "Descriptions",
        numColls: 1,
        colls: [
          [
            TicketEvent.eventFields.buyerDescription,
            TicketEvent.eventFields.managerDescription
          ]
        ]
      }
    ],
    eventItemLayout: [
      ...
      },
      {
        ...
        colls: [
          ...
          [
            TicketEvent.eventFields.ticketsAvailable,
            TicketEvent.eventFields.ticketsSold
          ]
        ]
      },
      {
    ...
    addVenueLayout: [
      {
        title: "Summary",
        numColls: 1,
        colls: [[Venue.venueFields.name]]
      },
      {
        title: "Address",
        numColls: 1,
        colls: [[Venue.venueFields.address]]
      }
    ],
    venueItemLayout: [
      {
