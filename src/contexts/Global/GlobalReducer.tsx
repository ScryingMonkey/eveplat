...
export const globalReducer = (
  ...
  switch (action.type) {
    ...
    case ActionType.DELETE_EVENT:
      action.payload.db.deleteDoc("events", action.payload.event.id);

      nstate.event.events = [
        ...nstate.event.events.filter(e => e.id !== action.payload.event.id)
      ];
      break;
    ...
    case ActionType.DELETE_VENUE:
      ...
      nstate.venue.venues = [
        ...nstate.venue.venues.filter(v => v.id !== action.payload.venue.id)
      ];
      break;
